{
  ...
  */
  ...
  TLegend* leg = new TLegend(0.50, 0.75, 0.87, 0.89);//(xmin, ymin, xmax, ymax)
  leg->AddEntry(Ldown, "Razor AV Expected -1#sigma (18.5 fb^{-1})" ,"l");
  leg->AddEntry(Lcom, "Razor AV Expected (18.5 fb^{-1})" ,"l");
  leg->AddEntry(Lup, "Razor AV Expected +1#sigma (18.5 fb^{-1})" ,"l");
  leg->AddEntry(Lc, "Razor AV Observed (18.5 fb^{-1})" ,"l");
  ...
  C->SetLogx();
  C->Update();
  C->SaveAs("AV_LambdaLimit_v2_BtagCorr_FullData_1D_IE.pdf");
  C->SaveAs("AV_LambdaLimit_v2_BtagCorr_FullData_1D_IE.png");
  C->SaveAs("AV_LambdaLimit_v2_BtagCorr_FullData_1D_IE.C");
