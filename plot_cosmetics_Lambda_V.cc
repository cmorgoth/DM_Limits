{
  ...
  TGraph* Ld = (TGraph*)f->Get("g2_05_lambda");
  TGraph* Lu = (TGraph*)f->Get("g3_05_lambda");
  TGraph* Lmono = (TGraph*)f->Get("g_mono_lambda_SI");
  ...
  C->SetLogx();
  C->Update();
  C->SaveAs("V_LambdaLimit.pdf");
  C->SaveAs("V_LambdaLimit.png");
